    ...
    <div class="back">
        <form action="quiz" method="post">
            <div class="listquiz-message">
                <p>CREATE NEW QUIZ</p>
                <input type="text" name="code" value="${code}" placeholder="Enter new code of quiz" class="text"><br>
                <input type="text" name="name" value="${name}" placeholder="Enter new name of quiz" class="text"><br>
                <input type="hidden" name="mod" value="4">
                <input type="submit" name="CONTINUE" value="CONTINUE" class="btn-submit"><br>
